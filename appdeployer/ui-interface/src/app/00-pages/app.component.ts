...
export class AppComponent extends BaseComponent implements AfterViewInit {
  ...
  constructor(private appInteractions: AppInteractions,
    ...
    this.appInteractions.getInputsWithId().getAllDirectories.subscribe((s) => {
    ...
    this.appInteractions.getInputsWithId().storeDirectoriesInfo.subscribe(data => {
      appData.getAccessors().storeDirectoriesInfo(data)
    });
