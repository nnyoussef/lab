...
<template>
  <div style="display: flex;flex-direction: column;height: 100%;min-height: 0;width: 100%">
    <div style="display: flex;align-items: center;">
      <img style="margin-right: 24px" height="80" width="80" src="../../public/logo.png" alt="File Indexer">
      <div style="height: 70px;width: 1px;background: lightgray"></div>
      <div style="margin-left: 24px">
        <p style="font-family: monospace;font-size: 2.2em;margin: 0">File Indexer</p>
        <p style="font-family: monospace;font-size: 1.2em;margin: 0">Version 0.0.1</p>
      </div>
    </div>
